...
interface CandidateName {
    ...
    Prefix?: string;  // Using '?' to indicate it's optional
    GivenName: string;
    Moniker?: string;  // Making it optional
    MiddleName?: string;  // Making it optional
    FamilyName: string;
    Suffix?: string;  // Making it optional
}
