...
export const formatDate = (dateDetail: string | undefined) => {
    ...
    if (dateDetail) {
      try {
        return format(parse(dateDetail, 'yyyy-MM-dd', new Date()), 'MM/yyyy');
      } catch (error) {
...
export const sectionConfigs: SectionConfig[] = [
    ...
    },
    {
        ...
        fieldsConfig: [
            ...
            { name: "organization", placeholder: "Prganization", type: "text", group: "name" },
            { name: "location", placeholder: "Location", type: "text" },
...
export const sampleResume = {
    ...
    summary: "A seasoned software engineer with over 10 years of experience in developing scalable web applications.",
    ...
    professional_experience: [
        {
            ...
            end_date: "Present",
            show: true,
            summary: "Leading a team of developers in creating web applications.",
            responsibilities: [
                {
                    _id: "res123",
                    content: "Developed and maintained multiple high-traffic web applications.",
                    detail: "Focused on React and Node.js stack.",
                    show: true,
                    starStory: "Successfully revamped a legacy system, resulting in a 50% performance increase."
                },
                {
                    _id: "res124",
                    content: "Developed and maintained multiple high-traffic web applications.",
    ...
    education: [
        {
            ...
            end_date: "2012-06-30",
            show: true,
            summary: "Specialized in software engineering and machine learning.",
            details: [
                {
                    _id: "edu-det123",
                    content: "Completed thesis on 'Machine Learning Algorithms in Web Applications'.",
                    detail: "",
                    show: true
                },
                {
    ...
    projects: [
        {
            ...
            details: [
                {
                    _id: "proj-det123",
                    content: "Developed a full-featured project management tool used by 500+ users.",
                    detail: "Utilized React, Redux, and Node.js.",
                    show: true
                },
                {
                    _id: "proj-det123",
