    ...
    return (
        <section className="w-full text-center py-8 md:py-10 xl:py-16 space-y-10">
            ...
            <Container className='flex w-full justify-center'>
                <iframe width="1120" height="630" src="https://www.youtube.com/embed/p_IuK0SL9Hs?si=6ZzSsCImLd8JEBcm&amp;controls=0" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
            </Container>
        </section >
    );
}
