...
const faqs = [
  {
    ...
    answer:
      'Nope, you can fill out a simple form to get started.',
  },
  {
    question: 'What is your pricing like?',
    answer:
      'Kyaria is free! We do not charge for our services.',
  },
  {
    question: 'How do I know my results are good.',
    answer:
      'Results are built upon templates provided by experienced industry professionals. However, it is still possible to get results that you are not happy with. If that happens, you can regenerate a response or copy and paste to a text editor of your choice to refine further.',
  },
  {
