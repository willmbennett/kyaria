...
export default function Post({ post }: { post: PostClass }) {
    ...
    return (
        <div className='w-full flex flex-col'>
            ...
            <div className="text-left border rounded-none bg-white shadow-sm hover:shadow-md transition-shadow duration-300">

                <div className="p-4 md:p-6">
                    <h1 className="sm:text-6xl text-4xl max-w-[708px] font-bold text-slate-900 mb-8">{title}</h1>
                    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
                        {author && <h6 className="text-lg font-medium text-neutral-700">By {author}</h6>}
