      ...
      <Container>
        <div className="relative mx-auto w-full max-w-lg sm:max-w-xl lg:mx-0 lg:max-w-none">
          ...
          <div className="w-full border border-gray-secondary-400/60 bg-gray-secondary-50 px-6 py-10 sm:p-14 lg:ml-auto lg:w-7/12 lg:py-32 lg:pl-28 xl:pl-36 xl:pr-20">
            ...
            <p className="mt-6 leading-relaxed text-slate-700 sm:mt-8 sm:text-lg sm:leading-8">
              Transform your job search into a strategic campaign with our intuitive funnel approach. From your Wishlist to the joy of an Accepted offer, track your journey with precision. Our sleek drag-and-drop interface simplifies the management of your applications, allowing you to focus on what matters. Instantly archive inactive applications to declutter your dashboard, while integrated metrics offer valuable insights for improvement. Elevate your job search experience with tools designed for success.
            </p>
            <AuthButton
              variant="ghost"
              size="md"
        ...
        <div className="relative mx-auto mt-48 w-full max-w-lg sm:max-w-xl lg:mx-0 lg:mt-32 lg:max-w-none">
          ...
          <div className="w-full border border-gray-secondary-400/60 bg-gray-secondary-50 px-6 py-10 sm:p-14 lg:w-7/12 lg:py-32 lg:pr-28 xl:pl-16 xl:pr-36 ">
            <h2 className="text-4xl font-semibold leading-tight text-slate-900 xl:text-5xl xl:leading-tight">
              Manage all your application packets
            </h2>
            <p className="mt-6 leading-relaxed text-slate-700 sm:mt-8 sm:text-lg sm:leading-8">
              Say goodbye to juggling spreadsheets, text editors, and folders for your job applications. Our system lets you create a unique resume, cover letter, elevator pitch, and more for each job, all stored in one place. Managing your job search has never been easier – everything you need for each application is right at your fingertips.
            </p>
            <AuthButton
              variant="ghost"
              size="md"
